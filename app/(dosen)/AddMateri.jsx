...
import { loadMaterials, saveMaterial } from '../../src/storage/materialStorage';
...
export default function AddMaterial() {
    ...
    useEffect(() => {
      loadMaterials().then(setMaterialList);
    }, []);
    ...
    const handleAddMaterial = async () => {
        ...
        Alert.alert("Materi berhasil ditambahkan");
    ...
    return (
        <ScrollView style={styles.screen} contentContainerStyle={{ paddingBottom: 30 }}>
            <View style={styles.card}>
                ...
                <TouchableOpacity onPress={() => handleAddMaterial()} style={{ marginTop: 18 }}>
                    <LinearGradient
