    ...
    return (
        <View style={[styles.card, {backgroundColor: card, borderColor: border, borderWidth: 1}]}>
            <View style={styles.info}>
                <Text style={[styles.title, {color: text}]}>{material.title}</Text>
                <Text style={[styles.subtitle, {color: text}]}>{material.kelas}</Text>
                <Text style={[styles.subtitle, {color: text}]}>Pertemuan: {material.session}</Text>
            </View>
      </View>
    );
}
